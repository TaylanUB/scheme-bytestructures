...
(let ((desc (make-bytestructure-descriptor `(,bsd:vector 2 ,uint16))))
  (test "vector" 
        (let ((bv (bytestructure desc)))
          (= 4 (bytevector-length bv)))
        (let ((bv (bytestructure desc (42 65535))))
          (and (= (bytestructure-ref bv desc 0) 42)
               (= (bytestructure-ref bv desc 1) 65535)))
        (let ((bv (bytestructure desc)))
          (bytestructure-set! bv desc 0 42)
          (bytestructure-set! bv desc 1 65535)
          (and (= (bytestructure-ref bv desc 0) 42)
               (= (bytestructure-ref bv desc 1) 65535)))))
...
(let ((desc (make-bytestructure-descriptor
  ...
  (test "struct"
        (let ((bv (bytestructure desc)))
          (= 4 (bytevector-length bv)))
        (let ((bv (bytestructure desc (42 65535))))
          (and (= (bytestructure-ref bv desc 'x) 42)
               (= (bytestructure-ref bv desc 'y) 65535)))
        (let ((bv (bytestructure desc)))
          (bytestructure-set! bv desc 'x 42)
          (bytestructure-set! bv desc 'y 65535)
          (and (= (bytestructure-ref bv desc 'x) 42)
               (= (bytestructure-ref bv desc 'y) 65535)))))
...
(let ((desc (make-bytestructure-descriptor
  ...
  (test "union"
        (let ((bv (bytestructure desc)))
          (= 1 (bytevector-length bv)))
        (let ((bv (bytestructure desc (0 255))))
          (and (= (bytestructure-ref bv desc 'x) -1)
               (= (bytestructure-ref bv desc 'y) 255)))
        (let ((bv (bytestructure desc)))
          (bytestructure-set! bv desc 'y 255)
          (and (= (bytestructure-ref bv desc 'x) -1)
               (= (bytestructure-ref bv desc 'y) 255)))))
